        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="flex flex-col gap-6">
                <div className="flex items-center gap-4 group">
                    <div className="w-12 h-12 rounded-full bg-zinc-900 border border-white/5 flex items-center justify-center group-hover:border-[#cf6701]/30 transition-colors">
                        <Mail className="w-5 h-5 text-[#b7ab98] group-hover:text-[#cf6701] transition-colors" />
                    </div>
                    <div>
          ...
          >
            <div className="p-8 lg:p-12 rounded-[2.5rem] bg-zinc-950 border border-white/5 shadow-2xl relative overflow-hidden">
                {/* Subtle Form Glow */}
                <div className="absolute -top-24 -right-24 w-48 h-48 bg-[#cf6701]/10 blur-[80px] rounded-full pointer-events-none" />
                ...
                {status === 'success' ? (
                  ...
                  >
                    <CheckCircle className="w-20 h-20 text-[#cf6701] mx-auto mb-6" />
                    ...
                    <button 
                        ...
                        className="px-8 py-3 bg-[#b7ab98] text-black rounded-full font-bold uppercase text-xs tracking-widest hover:bg-[#cf6701] transition-colors"
                    >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <input 
                                ...
                                type="text" 
                                name="name"
                                className="w-full bg-zinc-900 border border-white/5 rounded-2xl py-4 pl-12 pr-4 text-white placeholder:text-zinc-700 focus:outline-none focus:border-[#cf6701]/50 transition-colors"
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <textarea 
                                ...
                                name="message"
                                rows="4"
                                className="w-full bg-zinc-900 border border-white/5 rounded-2xl py-4 pl-12 pr-4 text-white placeholder:text-zinc-700 focus:outline-none focus:border-[#cf6701]/50 transition-colors resize-none"
                    ...
                    <button 
                        ...
                        type="submit"
                        className="w-full py-5 bg-[#b7ab98] text-black rounded-2xl font-bold uppercase text-xs tracking-[0.3em] hover:bg-[#cf6701] transition-all duration-500 shadow-xl shadow-black/20 flex items-center justify-center gap-3 group disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {status === 'sending' ? (
                            'ENVIANDO...'
                        ) : (
